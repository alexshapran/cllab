...
/**
 * This is the model class for table "sd_privacy_policy".
 *
 * The followings are the available columns in table 'sd_privacy_policy':
 * @property integer $id
 * @property integer $appraisal_id
 * @property integer $is_active
 * @property string $text
 */
class SdPrivacyPolicy extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return SdPrivacyPolicy the static model class
	 */
