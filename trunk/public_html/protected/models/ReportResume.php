...
/**
 * This is the model class for table "report_resume".
 *
 * The followings are the available columns in table 'report_resume':
 * @property integer $id
 * @property integer $appraisal_id
 * @property integer $is_active
 * @property string $title
 */
class ReportResume extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return ReportResume the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, appraisal_id, is_active, title', 'safe', 'on'=>'search'),
		);
	}
